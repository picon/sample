...
use picon\sample\general\tabs\TabOnePanel;
use picon\sample\general\tabs\TabTwoPanel;
use picon\web\markup\html\tabs\TabCollection;
use picon\web\markup\html\tabs\TabPanel;
